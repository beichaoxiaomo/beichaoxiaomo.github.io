$.getJSON({
    url: "	https://floor.jd.com/recommend-v20/focus_monetize/get?source=pc-home&callback=?&_=1652186012795" + Date.now()
}).then((data, textStatus, xhr) => {
    // console.log("请求成功", data);
    // 把数据渲染到页面中
    $(".lunbo").html(data.data.reduce((acc, value, item) => {
        return acc + `
        <a href="${value[0].href}"><img src="https:${value[0].src}" alt="">
        </a>
        `
    }, ""));
    ///轮播
